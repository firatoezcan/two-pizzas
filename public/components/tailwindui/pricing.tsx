...
import { RouterChildProps } from "preact-iso";

export const PricingPage: FC<RouterChildProps> = (props) => {
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6">
            <div className="flex items-center justify-between py-6 border-b border-indigo-400 border-opacity-25 md:justify-start md:space-x-10">
              ...
              <div className="-my-2 -mr-2 md:hidden">
                <button
                  type="button"
                  className="inline-flex items-center justify-center p-2 text-indigo-300 bg-indigo-900 rounded-md hover:text-white hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
              ...
              <nav className="hidden space-x-10 md:flex">
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center text-base font-medium text-white bg-indigo-900 rounded-md group hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-900 focus:ring-white"
                    onClick={() => setIsFlyoutOpen((b) => !b)}
                  >
                    <span>Solutions</span>
                    {/*
                    ...
                    */}
                    <svg
                      className="w-5 h-5 ml-2 text-indigo-300 group-hover:text-white"
              ...
              <div className="items-center justify-end hidden space-x-8 md:flex md:flex-1 lg:w-0">
                ...
                <a
                  href="/"
                  className="inline-flex items-center justify-center px-4 py-2 text-base font-medium text-indigo-600 bg-white border border-transparent rounded-md shadow-sm whitespace-nowrap hover:bg-indigo-50"
                >
                  Sign up
                </a>
              </div>
            ...
            <div className="w-full max-w-xs mt-10 lg:mt-0">
              ...
              <div className="mt-1.5 relative">
                <select
                  id="currency"
                  name="currency"
                  className="block w-full text-white bg-indigo-400 bg-opacity-25 border border-transparent rounded-md bg-none focus:ring-white focus:border-white"
                >
                  <option className="bg-gray-900">Argentina (ARS)</option>
                  <option className="bg-gray-900">Australia (AUD)</option>
                  <option className="bg-gray-900" selected>
                    United States (USD)
                  </option>
        ...
        <div className="space-y-24 lg:hidden">
          <div>
            ...
            <table className="w-full mt-8">
              <caption className="px-4 py-3 text-sm font-medium text-left text-gray-900 border-t border-gray-200 bg-gray-50">Features</caption>
              <thead>
                <tr>
            ...
            <table className="w-full">
              <caption className="px-4 py-3 text-sm font-medium text-left text-gray-900 border-t border-gray-200 bg-gray-50">Reporting</caption>
              <thead>
                <tr>
                  <th className="sr-only" scope="col">
                    Feature
            ...
            <table className="w-full">
              <caption className="px-4 py-3 text-sm font-medium text-left text-gray-900 border-t border-gray-200 bg-gray-50">Support</caption>
              <thead>
                <tr>
                  <th className="sr-only" scope="col">
                    Feature
          ...
          <table className="w-full h-px table-fixed">
            ...
            <thead>
              <tr>
                ...
                <th className="w-1/4 px-6 pb-4 text-lg font-medium leading-6 text-left text-gray-900" scope="col">
                  Basic
                </th>
            ...
            <tbody className="border-t border-gray-200 divide-y divide-gray-200">
              ...
              <tr>
                <th className="py-3 pl-6 text-sm font-medium text-left text-gray-900 bg-gray-50" colspan="4" scope="colgroup">
                  Features
                </th>
              </tr>

              <tr>
                <th className="py-5 pl-6 pr-6 text-sm font-normal text-left text-gray-500" scope="row">
                  Molestie lobortis massa.
                </th>
          ...
          <div className="mt-12">
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12 lg:grid-cols-3">
              <div className="space-y-2">
                <dt className="text-lg font-medium leading-6 text-gray-900">What's the best thing about Switzerland?</dt>
                <dd className="text-base text-gray-500">
                  I don't know, but the flag is a big plus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.
                </dd>
              </div>
              <div className="space-y-2">
                <dt className="text-lg font-medium leading-6 text-gray-900">How do you make holy water?</dt>
                <dd className="text-base text-gray-500">
                  You boil the hell out of it. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.
                </dd>
              </div>
              <div className="space-y-2">
                <dt className="text-lg font-medium leading-6 text-gray-900">Why do you never see elephants hiding in trees?</dt>
                <dd className="text-base text-gray-500">
                  Because they're so good at it. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.
                </dd>
              </div>
              <div className="space-y-2">
                <dt className="text-lg font-medium leading-6 text-gray-900">What do you call someone with no body and no nose?</dt>
                <dd className="text-base text-gray-500">Nobody knows. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.</dd>
              </div>
              <div className="space-y-2">
                <dt className="text-lg font-medium leading-6 text-gray-900">Why can't you hear a pterodactyl go to the bathroom?</dt>
                <dd className="text-base text-gray-500">Because the pee is silent. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.</dd>
              </div>
              <div className="space-y-2">
                <dt className="text-lg font-medium leading-6 text-gray-900">Why did the invisible man turn down the job offer?</dt>
                <dd className="text-base text-gray-500">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h4 className="text-sm font-semibold tracking-wider text-gray-400 uppercase">Solutions</h4>
                <ul className="mt-4 space-y-4">
                  <li>
              ...
              <div className="mt-12 md:mt-0">
                <h4 className="text-sm font-semibold tracking-wider text-gray-400 uppercase">Support</h4>
                <ul className="mt-4 space-y-4">
                  <li>
                    <a href="/" className="text-base text-gray-500 hover:text-gray-900">
                      Pricing
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                <h4 className="text-sm font-semibold tracking-wider text-gray-400 uppercase">Legal</h4>
                <ul className="mt-4 space-y-4">
                  <li>
                    <a href="/" className="text-base text-gray-500 hover:text-gray-900">
                      Claim
          ...
          <div className="mt-8 xl:mt-0">
            <h4 className="text-sm font-semibold tracking-wider text-gray-400 uppercase">Subscribe to our newsletter</h4>
            ...
            <form className="mt-4 sm:flex sm:max-w-md">
              ...
              <input
                ...
                autocomplete="email"
                required
                className="w-full min-w-0 px-4 py-2 placeholder-gray-500 bg-white border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                placeholder="Enter your email"
              />
              <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-red-600 bg-orange-100 border border-transparent rounded-md hover:bg-orange-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
                >
                  Subscribe
                </button>
              </div>
